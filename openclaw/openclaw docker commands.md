...
| ------------------------------------------ | -------------------------------- | ----------------------------------------------------------------------------------------------- |
| 초기 설정(온보드 위자드) 실행                          | `openclaw onboard`               | docker compose run --rm openclaw-cli onboard                                                    |
...
| 게이트웨이 포트 설정 (docker-setup.sh 실행 전 터미널에 추가) |                                  | export OPENCLAW_GATEWAY_PORT=원하는포트                                                              |
